...
saveRDS(qrup2,paste(pp,"/data/qrup.rds",sep=""))
saveRDS(qrlow2,paste(pp,"/data/qrlow.rds",sep=""))
###############################################################################################
...
#Data partly from: The Serengeti food web: empirical quantification and analysis of topological changes under increasing human impact.
#de Visser SN1, Freymann BP, Olff H. 2011 Journal of Animal Ecology 80(2)
#Also de Visser unpublished, and relevant GloBI records
...
#remove strictly aquatic animals 
...
###############################################################################################################
#Check with another Serengeti network
...
#From EltonTraits 1.0: Species-level foraging attributes of the world's birds and mammals data
...
#save number consumed of number predicted
